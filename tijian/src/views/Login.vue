    ...
    <div class="wrapper">
        ...
        <section>
            <div class="input-box">
                ...
                <svg t="1718281214268" class="w-5 h-5 text-gray-400 dark:text-gray-500" viewBox="0 0 1024 1024"
                ...
                <input v-model="user.userid" type="text" placeholder="输入手机号">
            </div>
            <div class="input-box">
                <i class="fa fa-lock"></i>

                <svg t="1718281349561" class="w-5 h-5 text-gray-400 dark:text-gray-500" viewBox="0 0 1024 1024"
                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="14724" width="20" height="20">
                    <path
                ...
                <input v-model="user.password" type="password" placeholder="输入登录密码">
            </div>
            <div class="reg-box">
            ...
            <p @click="login" class="button-box">登录</p>
        </section>
...
const login = () => {
    ...
    // axios.post('http://10.25.161.174:8080/login', user).then(res => {
...
.wrapper {
    ...
    width: 100%;
    height: 100%;
    /* 假设你的图片URL是 'your-image.jpg' 并且它位于与你的CSS文件相同的目录下 */
    background-image: url('../assets/img/back.png');
    /* 如果你想让图片覆盖整个元素，你可以添加以下属性 */
    background-size: cover;
    /* 如果你希望图片始终从元素的左上角开始显示，无论其大小如何，你可以添加以下属性 */
    background-position: top left;
    /* 默认情况下，背景图片不会重复，但如果你需要重复，可以添加以下属性 */
